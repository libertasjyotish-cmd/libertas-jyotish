// 手相×出生図 統合鑑定「カル・クンダリ」の章定義（9 章＋付章）。
...
${glossaryText('ja')}
9. 文字数の目安は下限。各項目に必ず「占術としてのアドバイス」を含める（いつ・何を・どう活かすか、何を避けるか、どの惑星・線を味方にするか）。要約や言い換えで埋めず、読者が明日から使える具体を書く。
10. 惑星の品位（座）は確定データの表記どおり書き、「敵対」「中立」という語は使わない。「試練で磨かれる座」は「その星は苦労を通して育つ」と読み、必ず育て方を添える。`,
  en: `[Voice]
...
${glossaryText('en')}
9. The character counts are minimums. Every field must contain practical astrological advice (when, what, how to use it, what to avoid, which planet or line to lean on). Never pad with summaries; write specifics the reader can use tomorrow.
10. Write planetary dignity exactly as given in the confirmed data; never use the words "enemy" or "neutral". A "tested" placement means the planet grows through effort, so always say how to grow it.`
};
...
const PALM_CHAPTERS = [
  {
    ...
    schema: `{
      ...
      "essence": "「あなたはこういう人です」と言い切る全体像。ラグナ・月・太陽・ナクシャトラ・手の形・目立つ印のうち、この人を最も特徴づける 3 点を名指しで根拠にして（520文字程度）",
      "rare": "この人にしかないもの。珍しい配置・強い惑星・手の印・星と手の一致のうち一つを選び、なぜそれが誰にでもあるものではないか（300文字程度）",
      "talents": ["この人の才能を一つづつ。「〜の才能：根拠の特徴」の形（呄40文字以内）", "", ""],
      "agreement": "出生図と手相が同じことを語っている主題と、それがこの人の人生にどう現れているか（220文字程度）",
      "difference": "出生図と手相で違って見える点＝「与えられた資質と、まだ使い切っていない資質」の差として（220文字程度。無ければ「大きな食い違いは見られません」）",
  ...
  },
  {
    ...
    schema: `{
      ...
      "lagna": "ラグナ（上昇宮）とその支配星の配置から、この人の器・第一印象・人生への向き合い方を言い当てる。「あなたは〜」で始め、根拠を名指し（450文字程度）",
      "moon": "月のサイン・ナクシャトラ・神格から、この人の心の癖・満たされるもの・人には見せない面を言い当てる（450文字程度。神格は確定データのもののみ）",
      "planets": [{ "planet": "この人を最も特徴づける惑星 3 つ（強い・珍しい・弱いのいずれかで選ぶ）", "placement": "サイン・ハウス・品位（確定データのみ）", "reading": "それがこの人の才能・気質・人生にどう現れるかを言い切り、使い方を一つ（220文字程度）" }],
      "atmakaraka": "アートマカーラカ（魂の指標星）から、今生でこの人が何をやりとげるために生まれたかを一つの使命として言い当てる（380文字程度）",
      "story": "上記を織り合わせた「魂の物語」の序章。この人がどんな役を耀って生まれたかを、物語の語りで（380文字程度）"
    }`
  },
  {
    id: 'ch2',
    ...
    schema: `{
      "intro": "手の上に九つの惑星（ナヴァグラハ）が住むという考え方を一文で、続けてこの人の手で何が一番目を引いたか（220文字程度）",
      "planets": [{ "planet": "確定データの惑星名をそのまま（太陽・月・火星・水星・木星・金星・土星・ラーフ・ケートゥの 9 つ）", "onHand": "対応する丘・指・線が写真でどう見えたか（unclear なら判読不可と書く。80文字程度）", "inChart": "出生図でのその惑星の配置と品位（60文字程度）", "reading": "両者を合わせて、この人の中でその惑星がどう働いているかを言い当てる（「あなたの〜はここから来ています」の形。180文字程度）" }],
      "closing": "この人の手と星で最も存在感のある惑星を一つ名指しし、それがこの人の「武器」であることと使い方（270文字程度）"
    }`
  },
  {
    id: 'ch3',
    ...
    schema: `{
      "intro": "「天（出生図）は与えられた資質、地（手）は今の使い方」を一文で、続けてこの人の天と地の照合結果の総評（一致が多いのか、だけでなく何を意味するのか。220文字程度）",
      "matches": [{ "theme": "一致した主題（30文字以内）", "chart": "出生図側の根拠（80文字程度）", "hand": "手相側の根拠（80文字程度）", "meaning": "天と地が重なったということは、この人においてその資質がどこまで本物か。言い切る（180文字程度）" }],
      "gaps": [{ "theme": "食い違った主題（30文字以内）", "chart": "出生図側（80文字程度）", "hand": "手相側（80文字程度）", "meaning": "「与えられているのにまだ使っていない力」として名指しし、使い始める方法を一つ（180文字程度）" }],
      "hands": "利き手（現在・後天）と非利き手（生来・先天）の違いから、この人が生まれてから今までに何を変えてきたかを言い当てる（300文字程度。asymmetry が空なら「両手に大きな差は見られません」とし、それが意味することを書く）",
      "closing": "照合から見えた「あなたの今の立ち位置」と、次に踏み出すべき一歩（220文字程度）"
    }`
  },
  {
    id: 'ch4',
    title: '第4章 天与の設計と現在地（差異が示す、目指すべき方向）',
    pick: (a) => ({
      palmRules: PALM_RULES, ...chartCore(a), dominantHand: dominant(a), boosters: a.boosters,
      dasha: { current: a.dasha?.current, upcoming: a.dasha?.upcoming?.slice(0, 2) },
      palm: { right: handOf(a, 'right'), left: handOf(a, 'left') }, asymmetry: a.palm?.asymmetry, unclear: a.palm?.unclear
    }),
    schema: `{
      "intro": "「生年月日（出生図）はあなたに与えられた設計図、手はいまの現在地」。この章では両者の差から進むべき方向を出す、と予告し、この人の差の全体像を一言で（150文字程度）",
      "blueprint": "出生図が示す本来の設計: ラグナ・最も強い惑星・アートマカーラカ・木星と土星の配置を名指しし、この人がどんな道を歩むよう設計されて生まれたかを言い切る（350文字程度）",
      "current": "手が示す現在地: 利き手の運命線・頭脳線・心の線・目立つ丘の見え方から、この人が設計のどこまでを実際に生き、どこで足を止めているかを言い当てる（350文字程度。unclear は正直に）",
      "distance": "設計と現在地のずれ: 出生図では強いのに手ではまだ薄い資質（眠っている扉）、手では育っているのに出生図では控えめな資質（自力で開いた扉）を各一つ以上名指しし、そのずれがこの人の人生でどう感じられてきたかを当てる（350文字程度。差が小さければ「設計どおりに生きている」と言い、それがどれほど稀かを書く）",
      "direction": "目指すべき方向を一文で言い切り（「あなたが向かうべきは〜です」）、なぜそれがこの人の設計と現在地の両方から導かれるのかを、星と手の根拠で語る（300文字程度）",
      "path": [{ "step": "その方向へ進む具体的な一手（3 つ挙げる。近い順に。40文字以内）", "why": "どの惑星・線・丘を味方にする手か（100文字程度）", "when": "現在のダシャーと次のダシャーから、いつ着手すると流れに乗れるか（確定データの「年・月」まで。日付は書かない。80文字程度））", "sign": "うまく進んでいるとき、手のどこ（線・丘）にどんな変化が現れるはずか（80文字程度）" }],
      "release": "この方向へ進むために手放すべきもの（癖・役割・思い込み）を一つ、出生図の弱い惑星や手の見え方を根拠に（200文字程度。否定ではなく卒業として）",
      "closing": "設計と現在地のあいだにある「余白」こそがこの人の伸びしろであることを、この人だけの言葉で（150文字程度）"
    }`
  },
  {
    id: 'ch5',
    title: '第5章 聖なるしるし（吉祥の印）',
    pick: (a) => ({
    ...
    schema: `{
      "intro": "魚・蓮・法螺貝・三叉など吉祥の印の伝統を一文で、続けてこの人の手に何があったか（あるいは無かったか）を語りのように（220文字程度）",
      "found": [{ "mark": "確定データの印の正式名称（【語り口】8 の用語表どおり。例: mystic_cross→神秘十字、great_triangle→大三角、fish→魚紋（マツヤ））", "where": "位置（確定データの location を訳す）", "confidence": "high/medium/low を「はっきり／おそらく／かすかに」と訳す", "tradition": "その印の伝統的な意味を一文で、続けてこの人の出生図のどの資質と呂応しているかを名指しで（220文字程度。具体的な出来事は断定しない）" }],
      "none": "印が一つも見つからない場合: それは欠落ではなく、この人の守りは代わりにどこ（強い惑星・神格）にあるか（220文字程度。found が空でなければ空文字）",
      "deity": "出生ナクシャトラの神格がこの人に授けた性質と、手の印の主題とのつながり。「あなたは〜の神に見守られて生まれた」という語り（270文字程度）",
      "closing": "この人にとっての「守りの記憶」を一つの言葉にして持たせる（180文字程度）"
    }`
  },
  {
    id: 'ch6',
    title: '第6章 三つのカルマ（蓄積・現在・創造）',
    pick: (a) => ({
    ...
    schema: `{
      "intro": "三つのカルマ（蓄積・現在・創造）の考え方を二文以内で、続けてこの人のカルマの全体像を一言で（220文字程度）",
      "sanchita": "非利き手の主要線とアートマカーラカから、この人が持って生まれたもの（才能・課題・魂の癖）を言い当てる。「あなたは〜を抱いて生まれてきた」の形で（380文字程度）",
      "prarabdha": "現在のダシャーと利き手の運命線・頭脳線から、いまこの人の人生で起きていることの正体と、この時期に与えられている課題を言い当てる（450文字程度）",
      "kriyamana": "この人がこれから自分で書き足せる部分。具体的にどの資質をどう使えば手（運命線・太陽線など）が変わるか、行動で示す（380文字程度）",
      "closing": "三つを一つの流れとして、この人の人生を一文の物語に（180文字程度）"
    }`
  },
  {
    id: 'ch7',
    title: '第7章 縁・仕事・決断（三つの領域）',
    pick: (a) => ({
    ...
    schema: `{
      "bonds": { "verdict": "この人の愛し方・人との結び方を一文で言い切る（60文字以内）", "chart": "金星・月・7 室の配置を名指しして、どういう人を引き寄せ、どういう関係で満たされ、どこでつまずきやすいか（300文字程度）", "hand": "感情線・金星丘・月丘の見え方がこの人の愛の現在形をどう裏付けるか（220文字程度）", "advice": "縁を育てるためにこの人だけがすべきことを一つ、行動で（180文字程度）" },
      "work": { "verdict": "この人が社会で担うべき役割を一文で言い切る（60文字以内。職種名ではなく役割で）", "chart": "太陽・土星・10 室・アートマカーラカを名指しして、この人の才能が最も輝く場面と、評価されにくい場面（300文字程度）", "hand": "運命線・太陽線・土星丘・木星丘から、その才能が今どこまで形になっているか（220文字程度。職種は断定しない）", "advice": "働き方の指針を一つ、行動で（180文字程度）" },
      "decisions": { "verdict": "この人の決断の型を一文で言い切る（60文字以内）", "chart": "水星・火星・木星の配置を名指しして、この人が迷うときの癖と、当たるときの判断の形（300文字程度）", "hand": "頭脳線・親指・火星丘から見える、この人の意志の強さと考え方の形（220文字程度）", "advice": "迷ったときにこの人が使うべき判断軸を一つ（180文字程度）" }
    }`
  },
  {
    id: 'ch8',
    title: '第8章 次の 12 か月（時の流れ）',
    pick: (a) => ({
    ...
    schema: `{
      "overview": "今後 12 か月をこの人のための一年として名付け（「○○の一年」）、なぜそう呼ぶかを、月から見た木星・土星・ラーフ/ケートゥの位置と、months[].transits[].touches に出ている「出生天体との重なり」（return は回帰）（例: 土星が出生の土星のいる牡羊座へ帰る、ラーフが出生の月の上を通る）を名指しして語る（380文字程度。期間は確定データの年月のみ）",
      "months": [{ "month": "確定データの YYYY-MM を 12 か月ぶん、順にすべて", "title": "その月にこの人へ付ける見出し（20文字以内。「調整期」のような一般語ではなく、「独立へ動く月」「縁が結び直される月」のように、この人の人生で何が動くかを言い切る）", "text": "この月の空でこの人にだけ起きること: どの天体が出生図のどのハウス・どの天体（touches）に触れるか→人生のどの領域（縁・仕事・家・心・学び・お金の姿勢など）が動くか→その月にこの人がすべき行動を一つ（180文字程度。turning に挙げる転機の月には「ここで動く月です」と読者の背中を押す一文を必ず入れ、それ以外の月には使わない。動きの少ない月は「仕込みの月」として前月からの続きで何を積むかを書く）" }],
      "turning": [{ "month": "YYYY-MM", "why": "keyShifts・touches のうち、この人にとって特別な意味を持つ移動（出生天体との重なり、ダシャー切替）を名指しして、なぜこの月が転機かを「この月、あなたは〜へ動きます」と言い切る（180文字程度。予言ではなく、何を始める・決める・手放す月かを示す）" }],
      "best": "この 12 か月で最も追い風が吹く月（YYYY-MM）と、そこでこの人が何を仕掛けるべきか（180文字程度）",
      "careful": "最も慎重に進むべき月（YYYY-MM）と、その月に守るべきこと一つ（150文字程度。不安を煽らず、恐怖表現なし）",
      "handCheck": "この 12 か月のあとに手のどこが変わっているはずか（lines の運命線・太陽線・頭脳線の現状を名指しして。180文字程度）",
      "closing": "この一年をどう生きるか、この人だけに向けた言葉（180文字程度）"
    }`
  },
  {
    id: 'ch9',
    title: '第9章 手は変わる（定点観測のすすめ）',
    pick: (a) => ({
    ...
    schema: `{
      "intro": "「手は生き方とともに変わる」を一文で、続けてこの人の手はこれからどう変わっていくと読むか（220文字程度）",
      "watch": [{ "feature": "見直すとよい特徴（線・丘の名前。30文字以内）", "now": "今回の写真での見え方（60文字程度。unclear なら判読不可と）", "why": "この人がどう生きるとそこがどう変わるか（出生図の根拠を添えて 150文字程度）" }],
      "practice": ["この人の星と手に合わせた日々の具体的な行動（各40文字以内。一般的な健康法は不可）", "", ""],
      "retake": "次に写真を撮るおすすめの時期と撮り方（確定データの年月のみ。180文字程度）",
      "message": "締めの言葉。この鑑定書で言い当てたこの人の最大の資質をもう一度名指しし、それを信じて進む背中を押す（300文字程度）"
    }`
  },
  {
    id: 'ch10',
    ...
    schema: `{
      "intro": "出生時刻が不確かなときラグナがずれる可能性と、手相を補助線として使う考え方（150文字程度）",
      "check": "手の形・指の長さ・丘の様子が、算出されたラグナの性質と整合しているか（380文字程度。整合しなくても断定はせず、確認の視点として）",
      "advice": "出生時刻を確かめる現実的な方法（母子手帳・出生証明など一般論。180文字程度）"
    }`
  }
];
