  ...
  if (isPaid && section === 'premium') {
    ...
    以下のJSONスキーマに従って ${outputLanguage} で100%出力してください：
    {
      ...
      "free_reading": {
        ...
        "influence": "本日受ける星の影響（150文字前後）。①で言い当てた状況が『なぜ今起きているか』を、トランジット天体と出生図の関係で説明し、読者の最近の判断を1文で肯定または意味づけする。",
